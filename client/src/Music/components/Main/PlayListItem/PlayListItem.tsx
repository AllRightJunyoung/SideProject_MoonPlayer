...
import { CircleTooltip, Flex, IconButton } from 'common/components';
...
export const PlayListItem = ({ name, img_url, id, source_url }: MusicItemType) => {
  ...
  return (
    <Styled.Layout direction="row" isActive={isCurrentMusic} alignItems="center" justifyContent="space-between">
      <Styled.MusicInfoBox direction="row" justifyContent="center" alignItems="center" onClick={handlePlayMusic}>
