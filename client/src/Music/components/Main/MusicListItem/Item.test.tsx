...
// import Item from 'components/Music/Main/MusicList/Item/Item';
...
//   renderWithProvider(<Item id={1} name={name} img_url={img_url} source_url={source_url}></Item>);
...
//     const { store } = renderWithProvider(<Item id={1} name={name} img_url={img_url} source_url={source_url}></Item>);
//     // 1. 장르에 대한 음악리스트 저장
